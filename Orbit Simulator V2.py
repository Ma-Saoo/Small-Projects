...
pygame.display.set_caption("Orbit Simulator V2") #Title of game
...
def main():
    ...
    while(run):
        ...
        if(a>=120 and a<=1020):#60 tick. So After 2 secs, sun mass starts to drop for 15 seconds until 0 (basically 0)
            sun.mass=sun.mass-2*10**27
            sun.color=(i,j,0)
            i=i-0.283
            j=j-0.283
        if(a>1020):
